...
\begin{wrapfigure}{l}{0.4\textwidth} %TODO!!!!
	...
	%\vspace{-10pt}
\end{wrapfigure}
Es ist möglich die über die Website \url{https://grn-x.github.io/sc-analysis/} die Startparameter festzulegen und dann einen 3D-Scatterplot kreieren zu lassen, der die resultierenden Winkel und Erfolgschancen widerspiegelt.
\\
Beim Durchrechnen fällt leider auf, dass Dom auch mit sehr großen Geschwindigkeiten, leider kaum eine Chance hat, den Kran in wirklich relevante Bewegung zu versetzen. 
\\
Außerdem muss leider angemerkt werden dass die Größe des durch die Haftreibung zusätzlich entstandenen Vektors verschwindend gering ist und kaum einen Einfluss auf das Gesamtergebnis hat
