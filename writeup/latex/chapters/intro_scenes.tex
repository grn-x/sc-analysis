...
\\
\\
Zum Ende der Szene ist die Kugel fast bis in den Vatikan vorgedrungen. Um den Zerstörung des nahegelegenen Petersplatzes zu verhindern, versucht Dom nun die rollende Bombe zu überholen und sie durch vorsichtiges Bremsen mit dem Heck seines Wagens direkt zu entschleunigen.
\\
...
\begin{wrapfigure}{r}{0.60\textwidth}
	...
	\vspace{10pt}
\end{wrapfigure}
Das Geschehen startet mit Doms scheiterndem Versuch, die Kugel direkt per Auto zu stoppen. Da ich diese Sequenz aus genau diesem Grund nicht weiter untersuchen werde, bekommt sie den Index 0. \footnote{Im Onlinerepositorium und in einigen anderen meiner Skizzen trägt diese Sequenz noch die Nummer 1. }%TODO
\\
...
\\
\\
Die übrigen Sequenzen stellen zwar interessante und untersuchenswerte Sachverhalte dar, die jedoch aus mangelnder Importanz im Kontext des Szenen-Ziels nicht weiter bearbeitet werden.
